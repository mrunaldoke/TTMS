...
<body>
    ...
    <div class="alert alert-success" role="alert">
        <h4 class="alert-heading">STUDENTS!</h4>
        <p>Attending classes regularly is a critical part of your academic success. By attending class, you have the opportunity to engage with your professors, learn from your peers, and actively participate in the learning process.</p>
        <hr>
        <p class="mb-0">Remember that each class session is designed to help you understand and master new concepts.</p>
      </div>
      
      <div>

      <table border='5' cellspacing='10' align='center' style='width: 90%; height: 650px;'>
      <tr bgcolor="#664097">
